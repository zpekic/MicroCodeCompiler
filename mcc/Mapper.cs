...
namespace mcc
{
    internal class Mapper : MemBlock
    {
        ...
        public Mapper(int lineNumber, int orgValue, string label, string content, object[] data) : base(lineNumber, orgValue, label, content, data)
        {
            this.Depth = -1;
            this.Width = -1;
        }
        ...
        protected override int GenerateVhdFile(FileInfo outputFileInfo, List<MicroField> fields)
        {
            ...
            System.Console.Write($"Generating mapper '{outputFileInfo.FullName}' ...");
