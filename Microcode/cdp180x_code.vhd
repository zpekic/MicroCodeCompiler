...
--
-- L0089.ct_oper: 4 values disable, enable default disable
--
...
-- L0140@0000._reset: reg_trace <= ss_enable_zero
...
-- L0142@0001._reset1: reg_trace <= ss_enable_zero
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 01, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
1 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "01" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0144@0002._reset2: reg_q <= zero,alu_f = xor, alu_r = d, alu_s = d, reg_in <= alu_y
...
-- L0148@0003._reset3: reg_r <= zero, sel_reg = zero,reg_mie <= enable,reg_t <= xp,alu_f = xor, alu_r = d, alu_s = d, reg_x <= n, reg_p <= n,reg_extend <= zero
...
-- L0156@0004.fetch: bus_state = fetch_memread, sel_reg = p, reg_in <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0160@0005.load_b: bus_state = exec_memread, sel_reg = x, reg_b <= alu_y, alu_f = pass_s, alu_s = bus,if traceEnabled then traceState else fork
...
-- L0167@0010.dma_or_int: if continue_sw then fetch else dma_or_int
...
-- L0170@0011.fetch1: bus_state = fetch_memread, sel_reg = p, reg_in <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else load_b
...
-- L0174@0013.int_ack: bus_state = int_nop,alu_f = pass_s, alu_s = const, reg_t <= xp, reg_x <= alu_yhi, reg_p <= alu_ylo,reg_mie <= disable,if true then fetch else 0x21
...
-- L0180@0015.dma_out: bus_state = dma_memread, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0184@0017. bus_state = dma_memread, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
--  bus_state = 0101, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
23 => X"5" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0188@0019.dma_in: bus_state = dma_memwrite, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0192@001B. bus_state = dma_memwrite, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
--  bus_state = 0110, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
27 => X"6" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0196@001D. bus_state = dma_memwrite, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
--  bus_state = 0110, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
29 => X"6" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0200@001F. bus_state = dma_memwrite, sel_reg = zero, reg_r <= r_plus_one,if continue then fetch else dma_or_int
--  bus_state = 0110, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
31 => X"6" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0210@0020.traceState: reg_trace <= ss_disable_char, if true then traceChar else 'D'
...
-- L0211@0021. reg_trace <= ss_disable_char, if true then traceChar else '='
...
-- L0212@0022. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0111
...
-- L0213@0023. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0110
...
-- L0214@0024. reg_trace <= ss_disable_char, if true then traceChar else ' '
...
-- L0216@0025. reg_trace <= ss_disable_char, if true then traceChar else 'B'
...
-- L0217@0026. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
38 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0218@0027. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0101
...
-- L0219@0028. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0100
...
-- L0220@0029. reg_trace <= ss_disable_char, if true then traceChar else ' '
--  bus_state = 0000, if (0000) then 01110111 else 00100000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
41 => X"0" & X"0" & X"77" & X"20" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0222@002A. reg_trace <= ss_disable_char, if true then traceChar else 'F'
...
-- L0223@002B. reg_trace <= ss_disable_char, if true then traceChar else 'L'
...
-- L0224@002C. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
44 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0225@002D. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0011
...
-- L0226@002E. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_0010
...
-- L0227@002F. reg_trace <= ss_disable_char, if true then traceChar else ' '
--  bus_state = 0000, if (0000) then 01110111 else 00100000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
47 => X"0" & X"0" & X"77" & X"20" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0229@0030. reg_trace <= ss_disable_char, if true then traceChar else 'X'
...
-- L0230@0031. reg_trace <= ss_disable_char, if true then traceChar else 'P'
...
-- L0231@0032. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
50 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0232@0033. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1111
...
-- L0233@0034. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1110
...
-- L0234@0035. reg_trace <= ss_disable_char, if true then traceChar else ' '
--  bus_state = 0000, if (0000) then 01110111 else 00100000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
53 => X"0" & X"0" & X"77" & X"20" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0236@0036. reg_trace <= ss_disable_char, if true then traceChar else 'I'
...
-- L0237@0037. reg_trace <= ss_disable_char, if true then traceChar else 'N'
...
-- L0238@0038. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
56 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0239@0039. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1001
...
-- L0240@003A. reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1000
...
-- L0242@003B. if false then next else traceSpR
...
-- L0243@003C. if false then next else traceReg0
...
-- L0245@003D. if false then next else traceSpR
--  bus_state = 0000, if (1111) then 00000000 else 01110100, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
61 => X"0" & X"F" & X"00" & X"74" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0246@003E. if false then next else traceReg1
...
-- L0248@003F. if false then next else traceSpR
--  bus_state = 0000, if (1111) then 00000000 else 01110100, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
63 => X"0" & X"F" & X"00" & X"74" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0249@0040. if false then next else traceReg2
...
-- L0251@0041. if false then next else traceSpR
--  bus_state = 0000, if (1111) then 00000000 else 01110100, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
65 => X"0" & X"F" & X"00" & X"74" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0252@0042. if false then next else traceRegX
...
-- L0254@0043. if false then next else traceSpR
--  bus_state = 0000, if (1111) then 00000000 else 01110100, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
67 => X"0" & X"F" & X"00" & X"74" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0255@0044. if false then next else traceRegP
...
-- L0257@0045. if false then next else traceSpR
--  bus_state = 0000, if (1111) then 00000000 else 01110100, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
69 => X"0" & X"F" & X"00" & X"74" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0258@0046. if false then next else traceRegN
...
-- L0260@0047. reg_trace <= ss_disable_char, if true then traceChar else 0x0D
...
-- L0261@0048. reg_trace <= ss_disable_char, if true then traceChar else 0x0A
...
-- L0263@0049. reg_trace <= ss_enable_zero,if sync then fork else repeat
...
-- L0266@004A.traceReg0: reg_trace <= ss_disable_char, if true then traceChar else '0'
...
-- L0267@004B. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
75 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0268@004C. sel_reg = zero, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0269@004D. sel_reg = zero, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0270@004E. sel_reg = zero, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0271@004F. sel_reg = zero, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0272@0050. if false then next else return
...
-- L0274@0051.traceReg1: reg_trace <= ss_disable_char, if true then traceChar else '1'
...
-- L0275@0052. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
82 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0276@0053. sel_reg = one, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0277@0054. sel_reg = one, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0278@0055. sel_reg = one, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0279@0056. sel_reg = one, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0280@0057. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
87 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0282@0058.traceReg2: reg_trace <= ss_disable_char, if true then traceChar else '2'
...
-- L0283@0059. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
89 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0284@005A. sel_reg = two, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0285@005B. sel_reg = two, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0286@005C. sel_reg = two, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0287@005D. sel_reg = two, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0288@005E. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
94 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0290@005F.traceRegX: reg_trace <= ss_disable_char, if true then traceChar else 'X'
--  bus_state = 0000, if (0000) then 01110111 else 01011000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
95 => X"0" & X"0" & X"77" & X"58" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0291@0060. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
96 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0292@0061. sel_reg = x, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0293@0062. sel_reg = x, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0294@0063. sel_reg = x, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0295@0064. sel_reg = x, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0296@0065. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
101 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0298@0066.traceRegP: reg_trace <= ss_disable_char, if true then traceChar else 'P'
--  bus_state = 0000, if (0000) then 01110111 else 01010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
102 => X"0" & X"0" & X"77" & X"50" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0299@0067. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
103 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0300@0068. sel_reg = p, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0301@0069. sel_reg = p, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0302@006A. sel_reg = p, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0303@006B. sel_reg = p, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0304@006C. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
108 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0306@006D.traceRegN: reg_trace <= ss_disable_char, if true then traceChar else 'N'
--  bus_state = 0000, if (0000) then 01110111 else 01001110, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
109 => X"0" & X"0" & X"77" & X"4E" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0307@006E. reg_trace <= ss_disable_char, if true then traceChar else '='
--  bus_state = 0000, if (0000) then 01110111 else 00111101, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
110 => X"0" & X"0" & X"77" & X"3D" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0308@006F. sel_reg = n, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1101
...
-- L0309@0070. sel_reg = n, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1100
...
-- L0310@0071. sel_reg = n, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1011
...
-- L0311@0072. sel_reg = n, reg_trace <= ss_disable_char, if true then traceChar else 0b1000_1010
...
-- L0312@0073. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
115 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0314@0074.traceSpR: reg_trace <= ss_disable_char, if true then traceChar else ' '
--  bus_state = 0000, if (0000) then 01110111 else 00100000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 11, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
116 => X"0" & X"0" & X"77" & X"20" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "11" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0315@0075. reg_trace <= ss_disable_char, if true then traceChar else 'R'
...
-- L0316@0076. if false then next else return
--  bus_state = 0000, if (1111) then 00000000 else 00000010, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 000, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
118 => X"0" & X"F" & X"00" & X"02" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"0" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0318@0077.traceChar: if traceReady then next else repeat
...
-- L0319@0078. reg_trace <= ss_disable_zero, if false then next else return
...
-- L0322@0079.XNOP: reg_extend <= zero, if false then next else NOP
...
-- L0328@007A.LDN: bus_state = exec_memread, sel_reg = n, alu_f = pass_s, alu_s = bus, reg_d <= alu_y,if continue then fetch else dma_or_int
...
-- L0332@007B.IDL: if true then next else next
...
-- L0334@007C. if continue then IDL else dma_or_int
...
-- L0338@007D.INC: sel_reg = n, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0342@007E.DEC: sel_reg = n, reg_r <= r_minus_one,if continue then fetch else dma_or_int
...
-- L0346@007F.SBRANCH: bus_state = exec_memread, sel_reg = p, alu_f = pass_s, alu_s = bus, reg_b <= alu_y,if cond_3X then sbranch2 else next
...
-- L0350@0080.SKIP: sel_reg = p, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0353@0081.sbranch2: sel_reg = p, reg_r <= rhi_ylo, alu_f = pass_r, alu_r = b,if continue then fetch else dma_or_int
...
-- L0357@0082.LDA: bus_state = exec_memread, sel_reg = n, alu_f = pass_s, alu_s = bus, reg_d <= alu_y, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0361@0083.STR: bus_state = exec_memwrite, sel_reg = n, alu_f = pass_r, alu_r = d,if continue then fetch else dma_or_int
...
-- L0365@0084.OUT: bus_state = exec_iowrite, sel_reg = x, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0369@0085.IRX: sel_reg = x, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0373@0086.INP: bus_state = exec_ioread, sel_reg = x, alu_f = pass_s, alu_s = bus, reg_d <= alu_y,if continue then fetch else dma_or_int
...
-- L0377@0087.EXTEND: if mode_1805 then next else NOP
...
-- L0379@0088. bus_state = fetch_memread, sel_reg = p, reg_in <= alu_y, alu_f = pass_s, alu_s = bus, reg_extend <= one,reg_r <= r_plus_one,if false then next else load_b
...
-- L0384@0089.RET: alu_f = pass_r, alu_r = b, reg_x <= alu_yhi, reg_p <= alu_ylo, reg_mie <= enable,sel_reg = x, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0389@008A.DIS: alu_f = pass_r, alu_r = b, reg_x <= alu_yhi, reg_p <= alu_ylo, reg_mie <= disable,sel_reg = x, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0394@008B.LDXA: alu_f = pass_r, alu_r = b, reg_d <= alu_y
...
-- L0396@008C. sel_reg = x, reg_r <= r_plus_one,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 011, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
140 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"3" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0400@008D.STXD: bus_state = exec_memwrite, alu_f = pass_r, alu_r = d, sel_reg = x
...
-- L0402@008E. sel_reg = x, reg_r <= r_minus_one,if continue then fetch else dma_or_int
...
-- L0407@008F.ADC: reg_extend <= zero, reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_s, alu_r = b, alu_s = d, alu_cin = df,if continue then fetch else dma_or_int
...
-- L0411@0090.SDB: reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_ns, alu_r = b, alu_s = d, alu_cin = df,if continue then fetch else dma_or_int
...
-- L0415@0091.SHRC: reg_d <= shift_dn_df, reg_df <= d_lsb,if continue then fetch else dma_or_int
...
-- L0420@0092.SMB: reg_extend <= zero, reg_df <= alu_cout, reg_d <= alu_y, alu_f = nr_plus_s, alu_r = b, alu_s = d, alu_cin = df,if continue then fetch else dma_or_int
...
-- L0424@0093.SAV: bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = t,if continue then fetch else dma_or_int
...
-- L0430@0095. bus_state = exec_memwrite, reg_x <= p, sel_reg = two, alu_f = pass_r, alu_r = t, reg_r <= r_minus_one,if continue then fetch else dma_or_int
...
-- L0434@0096.REQ: reg_q <= zero,if continue then fetch else dma_or_int
...
-- L0438@0097.SEQ: reg_q <= one,if continue then fetch else dma_or_int
...
-- L0443@0098.ADCI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else ADC
...
-- L0447@0099.SDBI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else SDB
...
-- L0451@009A.SHLC: reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_s, alu_r = d, alu_s = d, alu_cin = df,if continue then fetch else dma_or_int
...
-- L0456@009B.SMBI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else SMB
...
-- L0460@009C.GLO: reg_d <= alu_y, alu_f = pass_s, alu_s = reg_lo, sel_reg = n,if continue then fetch else dma_or_int
...
-- L0464@009D.GHI: reg_d <= alu_y, alu_f = pass_r, alu_r = reg_hi, sel_reg = n,if continue then fetch else dma_or_int
...
-- L0468@009E.PLO: reg_r <= rhi_ylo, alu_f = pass_r, alu_r = d, sel_reg = n,if continue then fetch else dma_or_int
...
-- L0472@009F.PHI: reg_r <= yhi_rlo, alu_f = pass_r, alu_r = d, sel_reg = n,if continue then fetch else dma_or_int
...
-- L0476@00A0.LBRANCH: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if cond_CX then next else SKIP
...
-- L0479@00A1. bus_state = exec_memread, sel_reg = p, reg_r <= rhi_ylo, alu_f = pass_s, alu_s = bus
...
-- L0481@00A2. sel_reg = p, reg_r <= yhi_rlo, alu_f = pass_r, alu_r = b,if continue then fetch else dma_or_int
...
-- L0491@00A3.LSKIP: if cond_CX then next else NOP
...
-- L0494@00A4.SKIP2: sel_reg = p, reg_r <= r_plus_one,if false then next else SKIP
...
-- L0498@00A5.NOP: if continue then fetch else dma_or_int
...
-- L0501@00A6.SEP: reg_p <= n,if continue then fetch else dma_or_int
...
-- L0505@00A7.SEX: reg_x <= n,if continue then fetch else dma_or_int
...
-- L0509@00A8.LDX: reg_d <= alu_y, alu_f = pass_r, alu_r = b,if continue then fetch else dma_or_int
...
-- L0513@00A9.OR: reg_d <= alu_y, alu_f = ior, alu_r = b, alu_s = d,if continue then fetch else dma_or_int
...
-- L0517@00AA.AND: reg_d <= alu_y, alu_f = and, alu_r = b, alu_s = d,if continue then fetch else dma_or_int
...
-- L0521@00AB.XOR: reg_d <= alu_y, alu_f = xor, alu_r = b, alu_s = d,if continue then fetch else dma_or_int
...
-- L0526@00AC.ADD: reg_extend <= zero, reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_s, alu_r = b, alu_s = d, alu_cin = f1_or_f0,if continue then fetch else dma_or_int
...
-- L0530@00AD.SD: reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_ns, alu_r = b, alu_s = d, alu_cin = f1_or_f0,if continue then fetch else dma_or_int
...
-- L0534@00AE.SHR: reg_d <= shift_dn_0, reg_df <= d_lsb,if continue then fetch else dma_or_int
...
-- L0539@00AF.SM: reg_extend <= zero, reg_df <= alu_cout, reg_d <= alu_y, alu_f = nr_plus_s, alu_r = b, alu_s = d, alu_cin = f1_or_f0,if continue then fetch else dma_or_int
...
-- L0543@00B0.LDI: bus_state = exec_memread, sel_reg = p, reg_d <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if continue then fetch else dma_or_int
...
-- L0547@00B1.ORI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else OR
...
-- L0551@00B2.ANI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else AND
...
-- L0555@00B3.XRI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else XOR
...
-- L0560@00B4.ADI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else ADD
...
-- L0564@00B5.SDI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else SD
...
-- L0568@00B6.SHL: reg_df <= alu_cout, reg_d <= alu_y, alu_f = r_plus_s, alu_r = d, alu_s = d, alu_cin = f1_or_f0,if continue then fetch else dma_or_int
...
-- L0573@00B7.SMI: bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one,if false then next else SM
...
-- L0580@00B8.STPC: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
...
-- L0584@00B9.DTC: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
185 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0588@00BA.SPM2: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
186 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0592@00BB.SCM2: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
187 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0596@00BC.SPM1: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
188 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0600@00BD.SCM1: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
189 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0604@00BE.LDC: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
190 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0608@00BF.STM: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
191 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0612@00C0.GEC: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
192 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0616@00C1.ETQ: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
193 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0620@00C2.XIE: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
194 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0624@00C3.XID: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
195 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0628@00C4.CIE: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
196 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0632@00C5.CID: reg_extend <= zero, sel_reg = n,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
197 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "00" & O"0" & '0' & X"0",

-- L0636@00C6.DBNZ: reg_extend <= zero, sel_reg = n, reg_r <= r_minus_one,if alu16_zero then skip2 else next
...
-- L0639@00C7. bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0641@00C8. bus_state = exec_memread, sel_reg = p, reg_r <= rhi_ylo, alu_f = pass_s, alu_s = bus
--  bus_state = 0001, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 101, reg_r <= 101, alu_r = 00, alu_s = 00, alu_f = 111, alu_cin = 0, ct_oper = 0000;
200 => X"1" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"5" & O"5" & "00" & "00" & O"7" & '0' & X"0",

-- L0643@00C9. sel_reg = p, reg_r <= yhi_rlo, alu_f = pass_r, alu_r = b,if continue then fetch else dma_or_int
--  bus_state = 0000, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 101, reg_r <= 100, alu_r = 10, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
201 => X"0" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"5" & O"4" & "10" & "00" & O"3" & '0' & X"0",

-- L0646@00CA.skip2: sel_reg = p, reg_r <= r_plus_one,if false then next else SKIP
--  bus_state = 0000, if (1111) then 00000000 else 10000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 101, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 000, alu_cin = 0, ct_oper = 0000;
202 => X"0" & X"F" & X"00" & X"80" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"5" & O"2" & "00" & "00" & O"0" & '0' & X"0",

-- L0650@00CB.BCI: reg_extend <= zero, bus_state = exec_memread, sel_reg = p, alu_f = pass_s, alu_s = bus, reg_b <= alu_y,if counterInt then sbranch2 else SKIP
...
-- L0654@00CC.BXI: reg_extend <= zero, bus_state = exec_memread, sel_reg = p, alu_f = pass_s, alu_s = bus, reg_b <= alu_y,if externalInt then sbranch2 else SKIP
...
-- L0658@00CD.RLXA: reg_extend <= zero, bus_state = exec_memread, sel_reg = x, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0660@00CE. bus_state = exec_memread, sel_reg = x, reg_t <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0662@00CF. sel_reg = n, reg_r <= yhi_rlo, alu_f = pass_r, alu_r = b, reg_b <= t
...
-- L0664@00D0. sel_reg = n, reg_r <= rhi_ylo, alu_f = pass_r, alu_r = b,if continue then fetch else dma_or_int
...
-- L0668@00D1.DSAV: reg_extend <= zero, sel_reg = x, reg_r <= r_minus_one
...
-- L0670@00D2. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = t, reg_r <= r_minus_one
...
-- L0672@00D3. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = d, reg_r <= r_minus_one, reg_b <= df_d_dn
...
-- L0674@00D4. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = b, reg_r <= r_minus_one,if continue then fetch else dma_or_int
...
-- L0678@00D5.SCAL: reg_extend <= zero, sel_reg = n, reg_t <= alu_y, alu_f = pass_s, alu_s = reg_lo
...
-- L0680@00D6. sel_reg = n, reg_b <= alu_y, alu_f = pass_r, alu_r = reg_hi
...
-- L0682@00D7. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = t, reg_r <= r_minus_one
--  bus_state = 0010, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 011, reg_r <= 011, alu_r = 00, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
215 => X"2" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"3" & O"3" & "00" & "00" & O"3" & '0' & X"0",

-- L0684@00D8. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = b, reg_r <= r_minus_one
...
-- L0686@00D9. sel_reg = p, reg_t <= alu_y, alu_f = pass_s, alu_s = reg_lo
...
-- L0688@00DA. sel_reg = p, reg_b <= alu_y, alu_f = pass_r, alu_r = reg_hi
...
-- L0690@00DB. sel_reg = n, reg_r <= b_t
...
-- L0692@00DC. bus_state = exec_memread, sel_reg = n, reg_t <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0694@00DD. bus_state = exec_memread, sel_reg = n, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0696@00DE. sel_reg = p, reg_r <= b_t,if continue then fetch else dma_or_int
...
-- L0700@00DF.SRET: reg_extend <= zero, sel_reg = n, reg_t <= alu_y, alu_f = pass_s, alu_s = reg_lo
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 01, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 11, alu_f = 111, alu_cin = 0, ct_oper = 0000;
223 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "01" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "11" & O"7" & '0' & X"0",

-- L0702@00E0. sel_reg = n, reg_b <= alu_y, alu_f = pass_r, alu_r = reg_hi
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 01, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 100, reg_r <= 000, alu_r = 11, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
224 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "01" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"4" & O"0" & "11" & "00" & O"3" & '0' & X"0",

-- L0704@00E1. sel_reg = x, reg_r <= r_plus_one
...
-- L0706@00E2. sel_reg = p, reg_r <= b_t
...
-- L0708@00E3. bus_state = exec_memread, sel_reg = x, reg_t <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
--  bus_state = 0001, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 01, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 011, reg_r <= 010, alu_r = 00, alu_s = 00, alu_f = 111, alu_cin = 0, ct_oper = 0000;
227 => X"1" & X"0" & X"00" & X"00" & O"0" & "00" & "01" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"3" & O"2" & "00" & "00" & O"7" & '0' & X"0",

-- L0710@00E4. bus_state = exec_memread, sel_reg = x, reg_b <= alu_y, alu_f = pass_s, alu_s = bus,if false then next else load_n
...
-- L0714@00E5.RSXD: reg_extend <= zero, sel_reg = n, reg_t <= alu_y, alu_f = pass_s, alu_s = reg_lo
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 01, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 11, alu_f = 111, alu_cin = 0, ct_oper = 0000;
229 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "01" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "11" & O"7" & '0' & X"0",

-- L0716@00E6. sel_reg = n, reg_b <= alu_y, alu_f = pass_r, alu_r = reg_hi
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 01, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 100, reg_r <= 000, alu_r = 11, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
230 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "01" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"4" & O"0" & "11" & "00" & O"3" & '0' & X"0",

-- L0718@00E7. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = t, reg_r <= r_minus_one
--  bus_state = 0010, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 011, reg_r <= 011, alu_r = 00, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
231 => X"2" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"3" & O"3" & "00" & "00" & O"3" & '0' & X"0",

-- L0720@00E8. bus_state = exec_memwrite, sel_reg = x, alu_f = pass_r, alu_r = b, reg_r <= r_minus_one,if continue then fetch else dma_or_int
--  bus_state = 0010, if (0110) then 00000100 else 00010000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 011, reg_r <= 011, alu_r = 10, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
232 => X"2" & X"6" & X"04" & X"10" & O"0" & "00" & "00" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"3" & O"3" & "10" & "00" & O"3" & '0' & X"0",

-- L0724@00E9.RNX: reg_extend <= zero, sel_reg = n, reg_t <= alu_y, alu_f = pass_s, alu_s = reg_lo
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 01, reg_b <= 00, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 01, sel_reg = 100, reg_r <= 000, alu_r = 00, alu_s = 11, alu_f = 111, alu_cin = 0, ct_oper = 0000;
233 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "01" & "00" & "00" & "00" & '0' & "00" & "00" & "00" & "01" & O"4" & O"0" & "00" & "11" & O"7" & '0' & X"0",

-- L0726@00EA. sel_reg = n, reg_b <= alu_y, alu_f = pass_r, alu_r = reg_hi
--  bus_state = 0000, if (0000) then 00000000 else 00000000, reg_d <= 000, reg_df <= 00, reg_t <= 00, reg_b <= 01, reg_x <= 00, reg_p <= 00, reg_in <= 0, reg_q <= 00, reg_mie <= 00, reg_trace <= 00, reg_extend <= 00, sel_reg = 100, reg_r <= 000, alu_r = 11, alu_s = 00, alu_f = 011, alu_cin = 0, ct_oper = 0000;
234 => X"0" & X"0" & X"00" & X"00" & O"0" & "00" & "00" & "01" & "00" & "00" & '0' & "00" & "00" & "00" & "00" & O"4" & O"0" & "11" & "00" & O"3" & '0' & X"0",

-- L0728@00EB. sel_reg = x, reg_r <= b_t,if continue then fetch else dma_or_int
...
-- L0732@00EC.RLDI: reg_extend <= zero, bus_state = exec_memread, sel_reg = p, reg_b <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0734@00ED. bus_state = exec_memread, sel_reg = p, reg_t <= alu_y, alu_f = pass_s, alu_s = bus, reg_r <= r_plus_one
...
-- L0736@00EE.load_n: sel_reg = n, reg_r <= b_t,if continue then fetch else dma_or_int
